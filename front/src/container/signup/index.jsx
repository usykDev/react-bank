    ...
    <Page>
      ...
      <form onSubmit={handleSubmit} className="page__section">
        <h1 className="page__header">
          <div className="page__title">Sign up</div>
          <div className="page__subtitle">Choose a registration method</div>
        </h1>
        <div className="form">
          <Field
            name="email"
          ...
          <FieldPassword
            ...
            errorMessage="This password does not match the first one"
